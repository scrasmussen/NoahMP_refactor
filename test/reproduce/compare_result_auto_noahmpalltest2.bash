...
#
 ...
 test1=Noahmp_all_default2
 test2=Noahmp_all_refactor5

 outdir1=/glade/campaign/ral/hap/cenlinhe/NoahMP_refactor/test_results_new/${test1}
 outdir2=/glade/campaign/ral/hap/cenlinhe/NoahMP_refactor/test_results_new/${test2}
