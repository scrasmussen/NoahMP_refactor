...
!---------------------------------------------------------------------
   ...
   !
    ...
    NoahmpIO%IOPT_RUN                          = runoff_option
...
! INOUT (with no Noah LSM equivalent) (as defined in WRF)
    ...
    allocate ( NoahmpIO%gecros_state (XSTART:XEND,60,YSTART:YEND) )   ! gecros crop model packed state vector
! irrigation
...
!------------------------------------------------------------------------
    ...
    if(NoahmpIO%SF_URBAN_PHYSICS > 0 )  then  ! any urban model
       ...
       allocate ( NoahmpIO%trb_urb4d      (XSTART:XEND,urban_map_zrd,YSTART:YEND) )  !
       allocate ( NoahmpIO%tw1_urb4d      (XSTART:XEND,urban_map_zwd,YSTART:YEND) )  !
       allocate ( NoahmpIO%tw2_urb4d      (XSTART:XEND,urban_map_zwd,YSTART:YEND) )  !
       allocate ( NoahmpIO%tgb_urb4d      (XSTART:XEND,urban_map_gd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%sfw1_urb3d     (XSTART:XEND,urban_map_zd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%sfw2_urb3d     (XSTART:XEND,urban_map_zd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%sfr_urb3d      (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%sfg_urb3d      (XSTART:XEND,num_urban_ndm,YSTART:YEND) )  !

       allocate ( NoahmpIO%hi_urb2d       (XSTART:XEND, num_urban_hi,   YSTART:YEND) )  !
       ...
       allocate ( NoahmpIO%tlev_urb3d     (XSTART:XEND,urban_map_bd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%qlev_urb3d     (XSTART:XEND,urban_map_bd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%tw1lev_urb3d   (XSTART:XEND,urban_map_wd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%tw2lev_urb3d   (XSTART:XEND,urban_map_wd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%tglev_urb3d    (XSTART:XEND,urban_map_gbd,YSTART:YEND) )  !
       allocate ( NoahmpIO%tflev_urb3d    (XSTART:XEND,urban_map_fbd,YSTART:YEND) )  !
       ...
       allocate ( NoahmpIO%sfwin1_urb3d   (XSTART:XEND,urban_map_wd ,YSTART:YEND) )  !
       allocate ( NoahmpIO%sfwin2_urb3d   (XSTART:XEND,urban_map_wd ,YSTART:YEND) )  !
       ! new urban variables greenroof & solar panel for BEM
       allocate ( NoahmpIO%ep_pv_urb3d    (XSTART:XEND,              YSTART:YEND) )  !
       allocate ( NoahmpIO%t_pv_urb3d     (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%trv_urb4d      (XSTART:XEND,urban_map_zgrd,YSTART:YEND) ) !
       allocate ( NoahmpIO%qr_urb4d       (XSTART:XEND,urban_map_zgrd,YSTART:YEND) ) !
       allocate ( NoahmpIO%qgr_urb3d      (XSTART:XEND,              YSTART:YEND) )  !
       allocate ( NoahmpIO%tgr_urb3d      (XSTART:XEND,              YSTART:YEND) )  !
       allocate ( NoahmpIO%drain_urb4d    (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%draingr_urb3d  (XSTART:XEND,              YSTART:YEND) )  !
       allocate ( NoahmpIO%sfrv_urb3d     (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%lfrv_urb3d     (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%dgr_urb3d      (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%dg_urb3d       (XSTART:XEND,num_urban_ndm,YSTART:YEND) )  !
       allocate ( NoahmpIO%lfr_urb3d      (XSTART:XEND,urban_map_zdf,YSTART:YEND) )  !
       allocate ( NoahmpIO%lfg_urb3d      (XSTART:XEND,num_urban_ndm,YSTART:YEND) )  !
...
!------------------------------------------------------------------------
    ...
    NoahmpIO%ICE             = 0
    NoahmpIO%COSZEN          = huge(1.0)
    NoahmpIO%XLAT            = huge(1.0)
    NoahmpIO%DZ8W            = huge(1.0)
    NoahmpIO%DZS             = huge(1.0)
    NoahmpIO%ZSOIL           = huge(1.0)
    NoahmpIO%IVGTYP          = huge(1)
    NoahmpIO%ISLTYP          = huge(1)
    NoahmpIO%SOILCL1         = huge(1.0)
    NoahmpIO%SOILCL2         = huge(1.0)
    NoahmpIO%SOILCL3         = huge(1.0)
    ...
    NoahmpIO%T_PHY           = huge(1.0)
    NoahmpIO%QV_CURR         = huge(1.0)
    NoahmpIO%U_PHY           = huge(1.0)
    NoahmpIO%V_PHY           = huge(1.0)
    NoahmpIO%SWDOWN          = huge(1.0)
    NoahmpIO%SWDDIR          = huge(1.0)
    NoahmpIO%SWDDIF          = huge(1.0)
    NoahmpIO%GLW             = huge(1.0)
    NoahmpIO%P8W             = huge(1.0)
    NoahmpIO%RAINBL          = huge(1.0)
    NoahmpIO%SNOWBL          = huge(1.0)
    NoahmpIO%RAINBL_tmp      = huge(1.0)
    NoahmpIO%SR              = huge(1.0)
    NoahmpIO%RAINCV          = huge(1.0)
    NoahmpIO%RAINNCV         = huge(1.0)
    NoahmpIO%RAINSHV         = huge(1.0)
    NoahmpIO%SNOWNCV         = huge(1.0)
    NoahmpIO%GRAUPELNCV      = huge(1.0)
    NoahmpIO%HAILNCV         = huge(1.0)
    NoahmpIO%TSK             = huge(1.0)
    NoahmpIO%QFX             = huge(1.0)
    NoahmpIO%SMSTAV          = huge(1.0)
    NoahmpIO%SMSTOT          = huge(1.0)
    NoahmpIO%SMOIS           = huge(1.0)
    NoahmpIO%SH2O            = huge(1.0)
    NoahmpIO%TSLB            = huge(1.0)
    NoahmpIO%SNOW            = huge(1.0)
    NoahmpIO%SNOWH           = huge(1.0)
    NoahmpIO%CANWAT          = huge(1.0)
    NoahmpIO%ACSNOM          = 0.0
    NoahmpIO%ACSNOW          = 0.0
    NoahmpIO%QSFC            = huge(1.0)
    NoahmpIO%SFCRUNOFF       = 0.0
    NoahmpIO%UDRUNOFF        = 0.0
    NoahmpIO%SMOISEQ         = huge(1.0)
    NoahmpIO%ALBEDO          = huge(1.0)
    NoahmpIO%ISNOWXY         = huge(1)
    NoahmpIO%TVXY            = huge(1.0)
    NoahmpIO%TGXY            = huge(1.0)
    NoahmpIO%CANICEXY        = huge(1.0)
    NoahmpIO%CANLIQXY        = huge(1.0)
    NoahmpIO%EAHXY           = huge(1.0)
    NoahmpIO%TAHXY           = huge(1.0)
    NoahmpIO%CMXY            = huge(1.0)
    NoahmpIO%CHXY            = huge(1.0)
    NoahmpIO%FWETXY          = huge(1.0)
    NoahmpIO%SNEQVOXY        = huge(1.0)
    NoahmpIO%ALBOLDXY        = huge(1.0)
    NoahmpIO%QSNOWXY         = huge(1.0)
    NoahmpIO%QRAINXY         = huge(1.0)
    NoahmpIO%WSLAKEXY        = huge(1.0)
    NoahmpIO%ZWTXY           = huge(1.0)
    NoahmpIO%WAXY            = huge(1.0)
    NoahmpIO%WTXY            = huge(1.0)
    NoahmpIO%TSNOXY          = huge(1.0)
    NoahmpIO%SNICEXY         = huge(1.0)
    NoahmpIO%SNLIQXY         = huge(1.0)
    NoahmpIO%LFMASSXY        = huge(1.0)
    NoahmpIO%RTMASSXY        = huge(1.0)
    NoahmpIO%STMASSXY        = huge(1.0)
    NoahmpIO%WOODXY          = huge(1.0)
    NoahmpIO%STBLCPXY        = huge(1.0)
    NoahmpIO%FASTCPXY        = huge(1.0)
    NoahmpIO%LAI             = huge(1.0)
    NoahmpIO%LAI_tmp         = huge(1.0)
    NoahmpIO%XSAIXY          = huge(1.0)
    NoahmpIO%TAUSSXY         = huge(1.0)
    NoahmpIO%XLONG           = huge(1.0)
    NoahmpIO%SEAICE          = huge(1.0)
    NoahmpIO%SMCWTDXY        = huge(1.0)
    NoahmpIO%DEEPRECHXY      = 0.0
    NoahmpIO%RECHXY          = 0.0
    NoahmpIO%ZSNSOXY         = huge(1.0)
    NoahmpIO%GRDFLX          = huge(1.0)
    NoahmpIO%HFX             = huge(1.0)
    NoahmpIO%LH              = huge(1.0)
    NoahmpIO%EMISS           = huge(1.0)
    NoahmpIO%SNOWC           = huge(1.0)
    NoahmpIO%T2MVXY          = huge(1.0)
    NoahmpIO%T2MBXY          = huge(1.0)
    NoahmpIO%Q2MVXY          = huge(1.0)
    NoahmpIO%Q2MBXY          = huge(1.0)
    NoahmpIO%TRADXY          = huge(1.0)
    NoahmpIO%NEEXY           = huge(1.0)
    NoahmpIO%GPPXY           = huge(1.0)
    NoahmpIO%NPPXY           = huge(1.0)
    NoahmpIO%FVEGXY          = huge(1.0)
    NoahmpIO%RUNSFXY         = huge(1.0)
    NoahmpIO%RUNSBXY         = huge(1.0)
    NoahmpIO%ECANXY          = huge(1.0)
    NoahmpIO%EDIRXY          = huge(1.0)
    NoahmpIO%ETRANXY         = huge(1.0)
    NoahmpIO%FSAXY           = huge(1.0)
    NoahmpIO%FIRAXY          = huge(1.0)
    NoahmpIO%APARXY          = huge(1.0)
    NoahmpIO%PSNXY           = huge(1.0)
    NoahmpIO%SAVXY           = huge(1.0)
    NoahmpIO%FIRAXY          = huge(1.0)
    NoahmpIO%SAGXY           = huge(1.0)
    NoahmpIO%RSSUNXY         = huge(1.0)
    NoahmpIO%RSSHAXY         = huge(1.0)
    NoahmpIO%BGAPXY          = huge(1.0)
    NoahmpIO%WGAPXY          = huge(1.0)
    NoahmpIO%TGVXY           = huge(1.0)
    NoahmpIO%TGBXY           = huge(1.0)
    NoahmpIO%CHVXY           = huge(1.0)
    NoahmpIO%CHBXY           = huge(1.0)
    NoahmpIO%SHGXY           = huge(1.0)
    NoahmpIO%SHCXY           = huge(1.0)
    NoahmpIO%SHBXY           = huge(1.0)
    NoahmpIO%EVGXY           = huge(1.0)
    NoahmpIO%EVBXY           = huge(1.0)
    NoahmpIO%GHVXY           = huge(1.0)
    NoahmpIO%GHBXY           = huge(1.0)
    NoahmpIO%IRGXY           = huge(1.0)
    NoahmpIO%IRCXY           = huge(1.0)
    NoahmpIO%IRBXY           = huge(1.0)
    NoahmpIO%TRXY            = huge(1.0)
    NoahmpIO%EVCXY           = huge(1.0)
    NoahmpIO%CHLEAFXY        = huge(1.0)
    NoahmpIO%CHUCXY          = huge(1.0)
    NoahmpIO%CHV2XY          = huge(1.0)
    NoahmpIO%CHB2XY          = huge(1.0)
    NoahmpIO%RS              = huge(1.0)
    ! additional output
    NoahmpIO%PAHXY           = huge(1.0)
    NoahmpIO%PAHGXY          = huge(1.0)
    NoahmpIO%PAHBXY          = huge(1.0)
    NoahmpIO%PAHVXY          = huge(1.0)
    NoahmpIO%QINTSXY         = huge(1.0)
    NoahmpIO%QINTRXY         = huge(1.0)
    NoahmpIO%QDRIPSXY        = huge(1.0)
    NoahmpIO%QDRIPRXY        = huge(1.0)
    NoahmpIO%QTHROSXY        = huge(1.0)
    NoahmpIO%QTHRORXY        = huge(1.0)
    NoahmpIO%QSNSUBXY        = huge(1.0)
    NoahmpIO%QSNFROXY        = huge(1.0)
    NoahmpIO%QSUBCXY         = huge(1.0)
    NoahmpIO%QFROCXY         = huge(1.0)
    NoahmpIO%QEVACXY         = huge(1.0)
    NoahmpIO%QDEWCXY         = huge(1.0)
    NoahmpIO%QFRZCXY         = huge(1.0)
    NoahmpIO%QMELTCXY        = huge(1.0)
    NoahmpIO%QSNBOTXY        = huge(1.0)
    NoahmpIO%QMELTXY         = huge(1.0)
    NoahmpIO%PONDINGXY       = 0.0
    NoahmpIO%FPICEXY         = huge(1.0)
    NoahmpIO%RAINLSM         = huge(1.0)
    NoahmpIO%SNOWLSM         = huge(1.0)
    NoahmpIO%FORCTLSM        = huge(1.0)
    NoahmpIO%FORCQLSM        = huge(1.0)
    NoahmpIO%FORCPLSM        = huge(1.0)
    NoahmpIO%FORCZLSM        = huge(1.0)
    NoahmpIO%FORCWLSM        = huge(1.0)
    NoahmpIO%ACC_SSOILXY     = 0.0
    NoahmpIO%ACC_QINSURXY    = 0.0
    NoahmpIO%ACC_QSEVAXY     = 0.0
    NoahmpIO%ACC_ETRANIXY    = 0.0
    NoahmpIO%EFLXBXY         = huge(1.0)
    NoahmpIO%SOILENERGY      = 0.0
    NoahmpIO%SNOWENERGY      = 0.0
    NoahmpIO%CANHSXY         = huge(1.0)
    ...
    NoahmpIO%TERRAIN         = huge(1.0)
    NoahmpIO%GVFMIN          = huge(1.0)
    NoahmpIO%GVFMAX          = huge(1.0)
    NoahmpIO%MSFTX           = huge(1.0)
    NoahmpIO%MSFTY           = huge(1.0)
    NoahmpIO%EQZWT           = huge(1.0)
    NoahmpIO%RIVERBEDXY      = huge(1.0)
    NoahmpIO%RIVERCONDXY     = huge(1.0)
    NoahmpIO%PEXPXY          = huge(1.0)
    NoahmpIO%FDEPTHXY        = huge(1.0)
    NoahmpIO%AREAXY          = huge(1.0)
    NoahmpIO%QRFSXY          = huge(1.0)
    NoahmpIO%QSPRINGSXY      = huge(1.0)
    NoahmpIO%QRFXY           = huge(1.0)
    NoahmpIO%QSPRINGXY       = huge(1.0)
    NoahmpIO%QSLATXY         = huge(1.0)
    NoahmpIO%QLATXY          = huge(1.0)
    NoahmpIO%CHSTARXY        = huge(1.0)
    NoahmpIO%Z0              = huge(1.0)
    NoahmpIO%ZNT             = huge(1.0)
    NoahmpIO%PGSXY           = huge(1)
    NoahmpIO%CROPCAT         = huge(1)
    NoahmpIO%PLANTING        = huge(1.0)
    NoahmpIO%HARVEST         = huge(1.0)
    NoahmpIO%SEASON_GDD      = huge(1.0)
    NoahmpIO%CROPTYPE        = huge(1.0)

    ! tile drainage
    NoahmpIO%QTDRAIN         = 0.0
    NoahmpIO%TD_FRACTION     = huge(1.0)
    ...
    NoahmpIO%LOCTIM          = huge(1.0)
 
    if(NoahmpIO%SF_URBAN_PHYSICS > 0 )then  ! any urban model
      NoahmpIO%HRANG           = huge(1.0)
      NoahmpIO%DECLIN          = huge(1.0)
      NoahmpIO%sh_urb2d        = huge(1.0)
      NoahmpIO%lh_urb2d        = huge(1.0)
      NoahmpIO%g_urb2d         = huge(1.0)
      NoahmpIO%rn_urb2d        = huge(1.0)
      NoahmpIO%ts_urb2d        = huge(1.0)
      NoahmpIO%GMT             = huge(1.0)
      NoahmpIO%JULDAY          = huge(1)
      NoahmpIO%frc_urb2d       = huge(1.0)
      NoahmpIO%utype_urb2d     = huge(1)
      NoahmpIO%lp_urb2d        = huge(1.0)
      NoahmpIO%lb_urb2d        = huge(1.0)
      NoahmpIO%hgt_urb2d       = huge(1.0)
      NoahmpIO%ust             = huge(1.0)
      NoahmpIO%cmr_sfcdif      = huge(1.0)
      NoahmpIO%chr_sfcdif      = huge(1.0)
      NoahmpIO%cmc_sfcdif      = huge(1.0)
      NoahmpIO%chc_sfcdif      = huge(1.0)
      NoahmpIO%cmgr_sfcdif     = huge(1.0)
      NoahmpIO%chgr_sfcdif     = huge(1.0)
      NoahmpIO%tr_urb2d        = huge(1.0)
      NoahmpIO%tb_urb2d        = huge(1.0)
      NoahmpIO%tg_urb2d        = huge(1.0)
      NoahmpIO%tc_urb2d        = huge(1.0)
      NoahmpIO%qc_urb2d        = huge(1.0)
      NoahmpIO%uc_urb2d        = huge(1.0)
      NoahmpIO%xxxr_urb2d      = huge(1.0)
      NoahmpIO%xxxb_urb2d      = huge(1.0)
      NoahmpIO%xxxg_urb2d      = huge(1.0)
      NoahmpIO%xxxc_urb2d      = huge(1.0)
      NoahmpIO%trl_urb3d       = huge(1.0)
      NoahmpIO%tbl_urb3d       = huge(1.0)
      NoahmpIO%tgl_urb3d       = huge(1.0)
      NoahmpIO%psim_urb2d      = huge(1.0)
      NoahmpIO%psih_urb2d      = huge(1.0)
      NoahmpIO%u10_urb2d       = huge(1.0)
      NoahmpIO%v10_urb2d       = huge(1.0)
      NoahmpIO%GZ1OZ0_urb2d    = huge(1.0)
      NoahmpIO%AKMS_URB2D      = huge(1.0)
      NoahmpIO%th2_urb2d       = huge(1.0)
      NoahmpIO%q2_urb2d        = huge(1.0)
      NoahmpIO%ust_urb2d       = huge(1.0)
      NoahmpIO%dzr             = huge(1.0)
      NoahmpIO%dzb             = huge(1.0)
      NoahmpIO%dzg             = huge(1.0)
      NoahmpIO%cmcr_urb2d      = huge(1.0)
      NoahmpIO%tgr_urb2d       = huge(1.0)
      NoahmpIO%tgrl_urb3d      = huge(1.0)
      NoahmpIO%smr_urb3d       = huge(1.0)
      NoahmpIO%drelr_urb2d     = huge(1.0)
      NoahmpIO%drelb_urb2d     = huge(1.0)
      NoahmpIO%drelg_urb2d     = huge(1.0)
      NoahmpIO%flxhumr_urb2d   = huge(1.0)
      NoahmpIO%flxhumb_urb2d   = huge(1.0)
      NoahmpIO%flxhumg_urb2d   = huge(1.0)
      NoahmpIO%chs             = huge(1.0)
      NoahmpIO%chs2            = huge(1.0)
      NoahmpIO%cqs2            = huge(1.0)
      NoahmpIO%mh_urb2d        = huge(1.0)
      NoahmpIO%stdh_urb2d      = huge(1.0)
      NoahmpIO%lf_urb2d        = huge(1.0)
      NoahmpIO%trb_urb4d       = huge(1.0)
      NoahmpIO%tw1_urb4d       = huge(1.0)
      NoahmpIO%tw2_urb4d       = huge(1.0)
      NoahmpIO%tgb_urb4d       = huge(1.0)
      NoahmpIO%sfw1_urb3d      = huge(1.0)
      NoahmpIO%sfw2_urb3d      = huge(1.0)
      NoahmpIO%sfr_urb3d       = huge(1.0)
      NoahmpIO%sfg_urb3d       = huge(1.0)
      NoahmpIO%hi_urb2d        = huge(1.0)
      NoahmpIO%theta_urban     = huge(1.0)
      NoahmpIO%u_urban         = huge(1.0)
      NoahmpIO%v_urban         = huge(1.0)
      NoahmpIO%dz_urban        = huge(1.0)
      NoahmpIO%rho_urban       = huge(1.0)
      NoahmpIO%p_urban         = huge(1.0)
      NoahmpIO%a_u_bep         = huge(1.0)
      NoahmpIO%a_v_bep         = huge(1.0)
      NoahmpIO%a_t_bep         = huge(1.0)
      NoahmpIO%a_q_bep         = huge(1.0)
      NoahmpIO%a_e_bep         = huge(1.0)
      NoahmpIO%b_u_bep         = huge(1.0)
      NoahmpIO%b_v_bep         = huge(1.0)
      NoahmpIO%b_t_bep         = huge(1.0)
      NoahmpIO%b_q_bep         = huge(1.0)
      NoahmpIO%b_e_bep         = huge(1.0)
      NoahmpIO%dlg_bep         = huge(1.0)
      NoahmpIO%dl_u_bep        = huge(1.0)
      NoahmpIO%sf_bep          = huge(1.0)
      NoahmpIO%vl_bep          = huge(1.0)
      NoahmpIO%tlev_urb3d      = huge(1.0)
      NoahmpIO%qlev_urb3d      = huge(1.0)
      NoahmpIO%tw1lev_urb3d    = huge(1.0)
      NoahmpIO%tw2lev_urb3d    = huge(1.0)
      NoahmpIO%tglev_urb3d     = huge(1.0)
      NoahmpIO%tflev_urb3d     = huge(1.0)
      NoahmpIO%sf_ac_urb3d     = huge(1.0)
      NoahmpIO%lf_ac_urb3d     = huge(1.0)
      NoahmpIO%cm_ac_urb3d     = huge(1.0)
      NoahmpIO%sfvent_urb3d    = huge(1.0)
      NoahmpIO%lfvent_urb3d    = huge(1.0)
      NoahmpIO%sfwin1_urb3d    = huge(1.0)
      NoahmpIO%sfwin2_urb3d    = huge(1.0)
      NoahmpIO%ep_pv_urb3d     = huge(1.0)
      NoahmpIO%t_pv_urb3d      = huge(1.0)
      NoahmpIO%trv_urb4d       = huge(1.0)
      NoahmpIO%qr_urb4d        = huge(1.0)
      NoahmpIO%qgr_urb3d       = huge(1.0)
      NoahmpIO%tgr_urb3d       = huge(1.0)
      NoahmpIO%drain_urb4d     = huge(1.0)
      NoahmpIO%draingr_urb3d   = huge(1.0)
      NoahmpIO%sfrv_urb3d      = huge(1.0)
      NoahmpIO%lfrv_urb3d      = huge(1.0)
      NoahmpIO%dgr_urb3d       = huge(1.0)
      NoahmpIO%dg_urb3d        = huge(1.0)
      NoahmpIO%lfr_urb3d       = huge(1.0)
      NoahmpIO%lfg_urb3d       = huge(1.0)
