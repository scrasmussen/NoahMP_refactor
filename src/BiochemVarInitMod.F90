...
!=== initialize with default values
  subroutine BiochemVarInitDefault(noahmp)
    ...
    noahmp%biochem%flux%VOCFLX      = huge(1.0) 
    ...
    noahmp%biochem%state%RSWOOD     = huge(1.0)
    noahmp%biochem%state%RSLEAF     = huge(1.0)
    noahmp%biochem%state%RSROOT     = huge(1.0)
    noahmp%biochem%state%DIELF      = huge(1.0)
    noahmp%biochem%state%DIEST      = huge(1.0)
    noahmp%biochem%state%ADDNPPLF   = huge(1.0)
    noahmp%biochem%state%ADDNPPST   = huge(1.0)
    noahmp%biochem%state%CARBFX     = huge(1.0)
    noahmp%biochem%state%LEAFPT     = huge(1.0)
    noahmp%biochem%state%LFTOVR     = huge(1.0)
    noahmp%biochem%state%STTOVR     = huge(1.0)
    noahmp%biochem%state%WDTOVR     = huge(1.0)
    noahmp%biochem%state%RSSOIL     = huge(1.0)
    noahmp%biochem%state%RTTOVR     = huge(1.0)
    ...
    noahmp%biochem%state%CBHYDRAFX  = huge(1.0) 
    noahmp%biochem%state%GRTOVR     = huge(1.0)
    noahmp%biochem%state%LFCONVERT  = huge(1.0)  
    noahmp%biochem%state%RSGRAIN    = huge(1.0)
