...
!!! Forcing variable initialization is done in ForcingInit.f90
  ...
  type, public :: forcing_type
    ...
    real(kind=kind_noahmp) :: Q2        !mixing ratio at lowest model layer [kg/kg]
    ...
    real(kind=kind_noahmp) :: SFCPRS    !pressure [pa]
    ...
    real(kind=kind_noahmp) :: QC        !cloud water mixing ratio [kg/kg]
    real(kind=kind_noahmp) :: QSFC      !mixing ratio at lowest model layer [kg/kg]
