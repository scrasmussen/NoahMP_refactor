...
contains
   ...
   ! ------------------------------------------------------------------------------------------
    ...
    call CarbonAssimilationFlux (noahmp)

    end associate

   end subroutine BiochemMain

end module BiochemMainMod
